          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="text-primary-foreground hover:bg-white/10 px-2 sm:px-3">
                <Image src="https://flagcdn.com/mr.svg" alt="Mauritania Flag" width={24} height={18} className="rounded-sm h-auto"/>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem>
                <div className="flex items-center gap-2">
                   <Image src="https://flagcdn.com/gb.svg" alt="Great Britain Flag" width={20} height={15} className="h-auto"/>
                  <span>English</span>
                </div>
              </DropdownMenuItem>
               <DropdownMenuItem>
                <div className="flex items-center gap-2">
                   <Image src="https://flagcdn.com/fr.svg" alt="France Flag" width={20} height={15} className="h-auto"/>
                  <span>Français</span>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
