...
import { Calendar, Car, Fuel, Gauge, Gem, MapPin, Palette, Phone, Wrench } from "lucide-react";
...
export default function CarDetailsPage({ params }: { params: { id: string } }) {
  ...
  const gallery = [car.image, ...Array(4).fill(0).map((_, i) => `https://picsum.photos/seed/${car.id + i + 1}/600/400`)]
    ...
    <div className="container py-12 md:py-20 bg-secondary">
      <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
        <div className="md:col-span-2">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-4 gap-2">
              {gallery.slice(1).map((img, i) => (
                <div key={i} className="relative aspect-video w-full overflow-hidden rounded-md cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="font-headline text-2xl text-primary">وصف الإعلان</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <div className="md:col-span-1 space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">التفاصيل الفنية</CardTitle>
                </CardHeader>
